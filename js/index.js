...
// let askUser = Number(prompt ('Enter the quantity of droids u want to buy'));

// let totalPrice = askUser * pricePerDroid;
...
// } else {
// console.log(`Вы купили ${askUser} дроидов, на счету осталось ${restCredits} кредитов`)
// }
...
// const askCountry = prompt('Укажите страну доставки товара')
// const toLowerCase = askCountry.toLowerCase();
// const China = 'китай';
// let ChinaCost = 100;
// const Chili = 'Чили';
// let ChiliCost = 250;
...
// switch (toLowerCase) {
//     case 'китай':
//         console.log(`Доставка в ${China} будет стоить ${ChinaCost} кредитов`);
//         break;
//     case 'чили': 
//         console.log(`Доставка в ${Chili} будет стоить ${ChiliCost} кредитов`);
//         break;
//     case 'австралия':
//             console.log(`Доставка в ${Australia} будет стоить ${AustraliaCost} кредитов`);
//             break;
//     case 'индия':
//             console.log(`Доставка в ${India} будет стоить ${IndiaCost} кредитов`);
//             break;
//      case 'ямайка':
//             console.log(`Доставка в ${Jamaica} будет стоить ${JamaicaCost} кредитов`);
//             break;
//     default:
...
// do {
//     input = Number(prompt('Введиет число')); 
//     total += input;     
//     console.log(total)
// } while(input !== 0 ) {
